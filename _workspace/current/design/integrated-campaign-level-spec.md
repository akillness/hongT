...
| # | 인수 | 상태 |
|---|---|---|
| 1 | 3구역 × 페이즈 게이트(보스 2기) — 게이트 수는 v0.2.0 3페이즈로 개정(1.2 정정 참조) | 확정 |
...
### 1.2 3룸 + 페이즈 게이트 (2026-08-07: 3페이즈로 정정)
- 룸 구성: **전투 룸 → (보스 룸) → Ember Rest → 다음 구역**.
- 페이즈 게이트: 구역 1·2는 보스 페이즈로 종결, 구역 3은 최종 보스(~~2페이즈~~ **3페이즈**(HACKSLASH AMENDMENT #4, HP 50%/20%) + Monarch P2 호위 3기 소환 — 2026-08-07 정정, 감사 LevelDesign G5).
