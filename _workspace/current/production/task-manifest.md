...
| AMENDMENT #7 수치 계약 | director | 1.d | docs/SIM_SPEC_HACKSLASH.md §14/§15 | G1 | done | 위 beat |
...
| AMENDMENT #7 EditMode 커버리지 | qa | 1.d | Assets/Tests/EditMode/TrainingSurgeTests.cs | G7,G8 | in-progress | 위 beat |
