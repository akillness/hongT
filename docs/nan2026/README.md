...
**팀원**: 정장영 (기획·QA · 아트리소스/UI/VFX/연출 구현) · 이석민 (기획·QA · UI/VFX/UX 구현) · 정우영 (기획·QA)
...
|---|---|---|---|---|
| 0 | 사전 과제 제출물 안내 | (참고) | [`00-submission-guide.md`](00-submission-guide.md) → [`pdf/00-submission-guide.pdf`](pdf/00-submission-guide.pdf) | 주최 요건 원문 + HongT 대응 현황 |
...
| 2 | 플레이 동영상 | YouTube 링크 (30~60초) | `assets/video/nan2026-cinder-court-unity-play.mp4` (58 s, 1440×900, CompressO 압축) | 배포 빌드 재캡처 완료 (일반 공격→스킬 핫키→텍스트 커맨드 콘솔) · **업로드 필요** |
| 3 | 게임 소개 및 설명 문서 | PDF | [`01-game-overview.md`](01-game-overview.md) → [`pdf/01-game-overview.pdf`](pdf/01-game-overview.pdf) | 마크다운·PDF 재생성 완료 |
| 4 | AI 활용 기술 문서 | PDF | [`02-ai-tech.md`](02-ai-tech.md) → [`pdf/02-ai-tech.pdf`](pdf/02-ai-tech.pdf) (동료 명령 콘솔·Gemini 2.5 Flash Lite 포함) | 마크다운·PDF 재생성 완료 |
| 5 | 팀원 롤 기술서 | PDF | [`03-team-roles.md`](03-team-roles.md) → [`pdf/03-team-roles.pdf`](pdf/03-team-roles.pdf) | 마크다운·PDF 재생성 완료 (3인 팀 정정 반영) |
...
```bash
node tools/video/capture-unity-play.mjs --seconds 58
```
